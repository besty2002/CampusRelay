    ...
    <div className="max-w-2xl mx-auto p-4 pt-12 pb-32">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-end mb-6 px-2">
          <h2 className="text-2xl font-black text-slate-800">내가 올린 나눔</h2>
        ...
        {myPosts.length === 0 ? (
          <div className="bg-white p-12 rounded-[2.5rem] border-2 border-dashed border-slate-100 text-center">
            ...
            <p className="text-slate-400 font-bold">아직 올린 나눔이 없습니다.</p>
            <Link to="/schools" className="text-lime-600 font-black text-sm mt-2 inline-block">첫 나눔 시작하기 &rarr;</Link>
          </div>
        ) : (
