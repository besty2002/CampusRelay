...
import { CreatePostDraftCard } from '../components/post/CreatePostDraftCard';
  ...
  return (
    <>
      <div className="mx-auto max-w-xl p-6 pb-32 pt-12">
        ...
        {!isEditMode && (
          <CreatePostDraftCard draftRestored={draftRestored} draftSavedAt={draftSavedAt} onClearDraft={clearDraft} />
        )}
