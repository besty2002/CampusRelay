...
interface AppointmentModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSubmit: (data: AppointmentDraft) => void;
  initialData?: AppointmentDraft | null;
  title?: string;
  submitLabel?: string;
}
...
export const AppointmentModal = ({
  ...
  useEffect(() => {
    ...
    if (initialData) {
      ...
      const isoTime = Number.isNaN(dateValue.getTime()) ? '' : dateValue.toTimeString().slice(0, 5);
